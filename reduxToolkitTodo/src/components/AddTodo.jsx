...
function AddTodo({editTodo, editId, clearEdit}) {
  ...
  const addTodoHandler = (e) => {
    ...
    if(editId) {
      dispatch(updateTodo({id: editId, updatedData: {text: input}}));
      clearEdit();
    } else {
  ...
  return (
    ...
    mt-12'>
        ...
        border-gray-700 focus:border-indigo-400
        ...
        rounded text-lg'
        >{editId ? 'UpdateTodo' : 'AddTodo'}</button>
    </form>
  )
}
